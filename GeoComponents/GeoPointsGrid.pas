...
type
  ...
  protected
    ...
    /// On failure sets FLastCommitFailed (inherited) when ciaBlock is active —
    /// TGeoGrid.SelectCell then blocks navigation automatically.
    /// </summary>
...
begin
  ...
  // Reset před validací — FLastCommitFailed je zděděný z TGeoGrid
