...
//  if Key = VK_RETURN then
//  begin
//    Key := 0; // Zabrání dalšímu zpracování Enteru
//
...
//    else
//    begin
//      // Přidání nového řádku, pokud je potřeba
//      if StringGrid1.Row = StringGrid1.RowCount - 1 then
//        StringGrid1.RowCount := StringGrid1.RowCount + 1;
//
//      StringGrid1.Row := StringGrid1.Row + 1;
...
//      begin
//        if not Assigned(PointDict) then
//          PointDict := TPointDictionary.Create;
//
//        PointDict.AddPoint(TPoint.Create(PointNumber, X, Y, Z, Quality, Description));
//      end
//      else
